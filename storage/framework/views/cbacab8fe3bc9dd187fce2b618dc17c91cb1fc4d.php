                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                             ...
                             <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('اضافة منتج')): ?>
                                <a  href="#exampleModal" class="modal-effect btn btn-sm btn-primary"  data-toggle="modal" data-effect="effect-scale" style="color: white"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\invoices\resources\views/products/products.blade.php ENDPATH**/ ?>