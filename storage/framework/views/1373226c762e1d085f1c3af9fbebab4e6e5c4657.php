...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(session()->has('add_invoice')): ?>
        <script>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="<?php echo e(url('InvoicesDetails')); ?>/<?php echo e($invoice->id); ?>"><?php echo e($invoice->invoice_number); ?></a>
                                        </td>

                                        <td><?php echo e($invoice->invoice_date); ?></td>
                                        <td><?php echo e($invoice->due_date); ?></td>
                                        <td>
                                            <?php echo e($invoice->section->section_name); ?>
                                        ...
                                        <td><?php echo e($invoice->value_rat); ?></td>
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('تعديل الفاتورة')): ?>
                                                        <a class="dropdown-item"
                                                            href="<?php echo e(url('edit_invoice')); ?>/<?php echo e($invoice->id); ?> "> <i
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('حذف الفاتورة')): ?>
                                                        <a class="dropdown-item" href="#"
                                                            data-invoice_id="<?php echo e($invoice->id); ?>" data-toggle="modal"
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('طباعة الفاتورة')): ?>
                                                        <a class="dropdown-item"
                                                            href="<?php echo e(url('print_invoice')); ?>/<?php echo e($invoice->id); ?>"><i
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('تغير حالة الدفع')): ?>
                                                        <a class="dropdown-item"
                                                            href="<?php echo e(url('edit_status')); ?>/<?php echo e($invoice->id); ?>"><i
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="<?php echo e(route('invoices.archive', 'test')); ?>" method="post">
                        <?php echo e(method_field('delete')); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\invoices\resources\views/invoices/invoices.blade.php ENDPATH**/ ?>