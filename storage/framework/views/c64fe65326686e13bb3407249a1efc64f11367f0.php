                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item"
                                                        href="<?php echo e(url('edit_invoice')); ?>/<?php echo e($invoice->id); ?> "> <i
                                                            class="fas fa-edit"></i> تعديل الفاتورة</a>
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="<?php echo e(url('edit_status')); ?>/<?php echo e($invoice->id); ?>"><i
                                                            class="fas fa-money-bill"></i> تغير حالة الدفع</a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\invoices\resources\views/invoices/partialInvoices.blade.php ENDPATH**/ ?>