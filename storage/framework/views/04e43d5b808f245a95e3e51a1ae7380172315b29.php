            ...
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('اضافة قسم')): ?>
                        <a href="#modaldemo8" class="modal-effect btn btn-sm btn-primary" data-toggle="modal"
                            data-effect="effect-scale" style="color: white"><i class="fas fa-plus"></i>&nbsp; اضافة قسم</a>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\invoices\resources\views/sections/sections.blade.php ENDPATH**/ ?>