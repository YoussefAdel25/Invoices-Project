                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div  class="dropdown-menu tx-13">
                                                    <a class="dropdown-item" href="{{ url('edit_invoice')}}/{{ $invoice->id }} "> <i class="fas fa-edit"></i> تعديل الفاتورة</a>

                                                    {{--  <a class="dropdown-item" href="#" data-invoice-id="{{ $invoice->id}}"
                                                        data-toggle="modal" data-target="#delete_invoice">  حذف الفاتورة</a>  --}}
                                                        ...
                                                        <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                                                            ...
                                                            <a  class="dropdown-item" href="{{ url('edit_status') }}/{{ $invoice->id }}"><i class="fas fa-money-bill"></i> تغير حالة الدفع</a>
