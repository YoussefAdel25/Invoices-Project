    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <form action="/customers/search" method="POST" role="search" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col">
                        ...
                        <div class="col-lg-3" id="startDate">
                            ...
                            <div class="input-group">
                                ...
                                </div><input type="text" class="form-control fc-datepicker" placeholder="YYYY-MM-DD"
                        ...
                        <div class="col-lg-3" id="endDate">
                            ...
                            <div class="input-group">
                                ...
                                </div><input type="text" placeholder="YYYY-MM-DD" name="endDate"
                                    value="{{ $endDate ?? '' }}" class="form-control fc-datepicker">
                            </div>
                        </div>
                ...
                success: function(data) {
                    ...
                    if (Object.keys(data).length > 0) {
                        $.each(data, function(key, value) {
                            productSelect.append('<option value="' + value + '">' + value +
                                '</option>');
                        });
                    } else {
