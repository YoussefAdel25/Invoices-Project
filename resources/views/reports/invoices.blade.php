                    ...
                    <form action="/invoices_search" method="post" role="search" autocomplete="off">
                        ...
                        <div class="col-lg-3">
                            <label class="radiobox">
                                <input type="radio" checked name="radio" value="1" id="type_div" <span>بحث بنوع
                                الفاتورة</span>
                            </label>
                        </div>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            <label class="radiobox"><input type="radio" value="2" name="radio"> <span>بحث برقم
                                    الفاتورة</span></label>
                        </div><br><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3" id="start_at">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control fc-datepicker" value="{{ $start_at ?? '' }}"
                            ...
                            <div class="col-lg-3" id="end_at">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control fc-datepicker" name="end_at"
